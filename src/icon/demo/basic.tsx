...
interface InputSearchProps {
  filterIcon: (T: Array<string>) => void;
}

const InputSearch: React.FC<InputSearchProps> = ({ filterIcon }) => {
  const [placeholder, setPlaceholder] =
    useState('输入英文关键词搜索，比如 arrow');
  return (
    <div className="icon-search">
      <input
        ...
        onBlur={() => {
          setPlaceholder('输入英文关键词搜索，比如 arrow');
        }}
        onChange={event => {
          const newList = iconList.filter(item => {
...
const Icons: React.FC<IconsProps> = ({ iconList }) => {
  return (
    <div className="icons">
...
const AllIcon = () => {
  ...
  const filterIcon = (list: Array<string>) => {
    setIcons(list);
  };
  return (
    <>
      <InputSearch filterIcon={filterIcon}></InputSearch>
